  ...
  <div class="login-vue">
    <div class="login-container">
      <div class="login-content">
        <div class="login-logo"><img :src="require('images/' + website.logo)"></div>
        <div class="login-title">{{ website.name }}</div>
      ...
      <div class="copyright"> 
        <p>{{ website.schoolName }}</p>
        <div class="beian">
          <p>互联网ICP备案：<a target="_blank" href="http://www.beian.miit.gov.cn">{{ website.ICP }}</a></p>
          <p><a target="_blank" :href="website.beianUrl">{{ website.beian }}</a></p>
          <p>{{ website.designTeam }}</p>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      website: Website,  //导入website网站配置项
      login: Login.parse({}),
      loading: false
    };
  },
